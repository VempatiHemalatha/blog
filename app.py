...
with mysql.connector.connect(host='localhost',password='system',user='root',db='blog'):
    ...
    cursor.execute("create table if not exists registration(username varchar(30)primary key,moblie varchar(50) ,email varchar(50) ,address varchar(50),password varchar(20))")
...
def otp(username,mobile,address,email,password,otp):
    if request.method=='POST':
